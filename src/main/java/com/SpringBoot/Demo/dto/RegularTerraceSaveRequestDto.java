...
public class RegularTerraceSaveRequestDto {
	...
	public String toString() {
		return "RegularTerraceRoomSaveRequestDto [regular_terrace_number=" + regular_terrace_number + ", member="
				+ member + ", create_date=" + create_date + ", terrace_name=" + terrace_name + ", terrace_mop="
				+ terrace_mop + ", terrace_freq=" + terrace_freq + ", terrace_date=" + terrace_date + "]";
	}
