	...
	$.ajax({
        ...
        success: function(result) {
			...
			$.each(itemList, function(index,values) {
				...
				str+='<tr> <td class="itemcheckboxes" style="margin-top: 0px;margin-left: 0px;margin-right: 0px;width: 45px; padding-top: 8px; padding-bottom: 8px; padding-left: 5px; padding-right: 5px; background-color: #f1f4f7;">';
